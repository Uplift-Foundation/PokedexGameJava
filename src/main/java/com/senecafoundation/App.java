                ...
                if (userResponse.equals(Pokedex.color)) {
                    ...
                    if (userResponse.equals("Yes")) {
                        while (userResponse.equals("Yes")) { //chooses random Pokemon from TempList
                            ...
                            // comparer = new comparier(TempPokemon.get(rd.nextInt(9)), ChallengerContents.get(rd.nextInt(13))
                            // comparer.setPokemon1(TempPokemon.get(rd.nextInt(9))
                            // comparer.setPokemon2(ChallengerContents.get(rd.nextInt(13))
